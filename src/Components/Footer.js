    ...
    return (
        <div className='footer-full'>
            <p className='text '>blockspin.bet © |
                <a href=' https://blockspin-protocol.gitbook.io/' className='doc' style={{ textDecoration: 'none', marginLeft: '3px', marginRight: '3px', fontFamily: 'Iceland' }}>
                    documentation
                </a>

                |
                <a href='https://x.com/8lockspin' style={{ marginLeft: '5px' }}><svg className='color' width="20" height="20" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g opacity="0.5">
